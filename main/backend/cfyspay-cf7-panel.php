        ...
        <table class="cf7wpay_paypal_main">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="enabled_stripe_Sandbox" <?php if(get_post_meta( $formid, 'cf7wpay_enabled_stripe_Sandbox', true ) == "on"){ echo "checked"; } ?>><label><?php echo esc_html_e('Use Sandbox','stripe-with-contact-form-7');?></label>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
...
function cf7spay_ajax_json_echo( $response, $result ) {
    ...
    $customer_email         = get_post_meta( $formid, 'cf7wpay_customer_email', true );
    $stripe_customer_email  = get_post_meta( $formid, 'cf7wpay_stripe_customer_email', true );
    $customer               = get_post_meta( $formid, 'cf7wpay_customer_email', true );
    $item_id_sku            = get_post_meta( $formid, 'cf7wpay_item_id_sku', true );
